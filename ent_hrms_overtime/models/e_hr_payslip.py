...
class PayslipOverTime(models.Model):
    ...
    def _compute_input_line_ids(self):
        ...
        overtime_type = self.env.ref('ent_hrms_overtime.hr_salary_rule_overtime')
        overtime_input_type = self.env.ref('ent_hrms_overtime.input_overtime_payroll')
        ...
        if overtime_id and self.struct_id and overtime_input_type in self.struct_id.input_line_type_ids:
            ...
            #     'input_type_id': self.env.ref('ent_hrms_overtime.input_overtime_payroll').id if self.env.
            #     ref('ent_hrms_overtime.input_overtime_payroll').id else 1
            # }
